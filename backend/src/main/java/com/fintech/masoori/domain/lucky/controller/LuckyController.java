...
public class LuckyController {
	...
	public ResponseEntity<FortuneRes.Fortune> selectLoginFortune(Principal principal) {
		FortuneRes.Fortune fortune = fortuneService.selectOneFortune(principal.getName());
	...
	public ResponseEntity<FortuneRes.Fortune> selectFortune() {
		FortuneRes.Fortune fortune = fortuneService.selectOneFortune("");
		return ResponseEntity.ok(fortune);
	}
	...
	public ResponseEntity<FortuneRes> selectAllFortune() {
		FortuneRes fortuneList = fortuneService.selectAllFortune();
	...
	public ResponseEntity<FortuneRes> selectAllUserFortune(Principal principal) {
		...
		FortuneRes fortuneList = fortuneUserService.selectAllUserFortune(principal.getName());
		return ResponseEntity.ok(fortuneList);
	}
