...
public class WebSecurityConfig {
	private static final String[] WHITE_LIST = {"/api/user/signup", "/api/user/login", "/api/user/check", "/api/user/","/api/user//email-duplication/check",
		"/api/user/email/check", "/api/lucky/fortune","/api/lucky/color", "/swagger-ui/**", "/v3/**","/api/rabbit/**"};
